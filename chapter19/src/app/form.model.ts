            ...
            for (let errorName in this.errors) {
                switch(errorName) {
                    ...
                    case "minlength":
                        ...
                        break;
                    case "maxlength":
                        messages.push(`A ${this.label} must be at least ${this.errors['maxlength'].requiredLength} characters`);
                        break;
                    case "pattern":
    ...
    constructor() {
        super({
            ...
            price: new ProductFormControl("Price", "price", "", Validators.compose([
                Validators.required, Validators.pattern("^[0-9\.]+$"), LimitValidator.Limit(100)
            ]))
        })
    }
